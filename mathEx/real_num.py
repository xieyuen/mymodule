...
def __int  (self) -> int:   return int(self.num)
def __float(self) -> float: return float(self.num)
def __str  (self) -> str:   return str(self.num)
...
# 数学运算(加、减、乘、除、模等等)
def __add      (self, other: Real) -> Real: return Real(self.num + other.num)  if isinstance(other, Real) else (Real(self.num + other)  if (isinstance(other, int) or isinstance(other, float)) else NotImplemented)
def __sub      (self, other: Real) -> Real: return Real(self.num - other.num)  if isinstance(other, Real) else (Real(self.num - other)  if (isinstance(other, int) or isinstance(other, float)) else NotImplemented)
def __mul      (self, other: Real) -> Real: return Real(self.num * other.num)  if isinstance(other, Real) else (Real(self.num * other)  if (isinstance(other, int) or isinstance(other, float)) else NotImplemented)
def __div      (self, other: Real) -> Real: return Real(self.num / other.num)  if isinstance(other, Real) else (Real(self.num / other)  if (isinstance(other, int) or isinstance(other, float)) else NotImplemented)
def __floordiv (self, other: Real) -> Real: return Real(self.num // other.num) if isinstance(other, Real) else (Real(self.num // other) if (isinstance(other, int) or isinstance(other, float)) else NotImplemented)
def __truediv  (self, other: Real) -> Real: return Real(self.num / other.num)  if isinstance(other, Real) else (Real(self.num / other)  if (isinstance(other, int) or isinstance(other, float)) else NotImplemented)
def __mod      (self, other: Real) -> Real: return Real(self.num % other.num)  if isinstance(other, Real) else (Real(self.num % other)  if (isinstance(other, int) or isinstance(other, float)) else NotImplemented)
def __pow      (self, other: Real) -> Real: return Real(self.num ** other.num) if isinstance(other, Real) else (Real(self.num ** other) if (isinstance(other, int) or isinstance(other, float)) else NotImplemented)
def __divmod   (self, other: Real) -> Tuple[Real, Real]: return (self.__div__(other), self.__mod__(other)) if isinstance(other, Real) else ((self.__div__(Real(other)), self.__mod__(Real(other))) if (isinstance(other, int) or isinstance(other, float)) else NotImplemented)
